...
#define DEF_BLOCK_Y   8
 ...
 __global__ void _thinGuoHallIter1Ker(ImageCuda outimg, ImageCuda tempimg, int *devchangecount,
 ...
 __host__ int Thinning_gpu::thinGuoHall(Image *inimg, Image *outimg)
 {
     // 局部变量，错误码。
     int errcode;  
